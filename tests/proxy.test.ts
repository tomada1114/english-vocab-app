...
// prefixes render. Disagree, and `/` 404s — or `/api/hello` gets redirected to
// `/en/api/hello` — with every other suite still green, because nothing else
// in the repository reads both halves.
