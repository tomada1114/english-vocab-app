...
const MESSAGE_KEYS = [
  ...
  "HomePage.title",
  "HomePage.intro",
  "HomePage.settingsTitle",
  "HomePage.scopeTitle",
  "HomePage.purposeLabel",
  "HomePage.topicsLabel",
  "HomePage.allTopicsHint",
  "HomePage.targetLabel",
  "HomePage.noTarget",
  "HomePage.newCardsPerDayLabel",
  "HomePage.saving",
  "HomePage.saveError",
  "HomePage.progressTitle",
  "HomePage.dueTodayLabel",
  "HomePage.rememberedNowLabel",
  "HomePage.unlearnedLabel",
  "HomePage.targetRatioLabel",
  "HomePage.percentage",
  "HomePage.startTitle",
  "HomePage.start",
  "HomePage.nothingToStudy",
  "HomePage.noCards",
  "HomePage.generateCards",
  "ProgressCurve.title",
  "ProgressCurve.empty",
  "ProgressCurve.accessible",
  "ProgressCurve.today",
  "StudyPage.title",
  "StudyPage.loading",
  "StudyPage.error",
  ...
  "StudyPage.easy",
  "SummaryPage.title",
  "SummaryPage.reviewed",
  "SummaryPage.remembered",
  "SummaryPage.homeLink",
  "NotFound.title",
